...
mobilenetssd = cv2.dnn.readNetFromCaffe('models/mobilenetssd.prototext','models/mobilenetssd.caffemodel')
...
# Esta línea detiene la ejecución hasta que presiones cualquier tecla
cv2.waitKey(0) 

# Esta línea limpia la memoria y cierra las ventanas de OpenCV
